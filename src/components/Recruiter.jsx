...
const Recruiter = () => {
  ...
  return (
    <div className={`w-full flex-col ${styles.paddingX} sm:mt-20  pt-[180px] `}>
      ...
      <div
        className={`hidden w-full${styles.flexCenter} ${styles.boxWidth} sm:flex flex-row`}
      >
        <div
          className={`flex-1 w-full sm:w-auto flex flex-col ${styles.flexStart} `}
        >
          <h1 className={`${styles.heading2}`}>recruit with learnmutiny</h1>
          <p className={`${styles.paragraph} mt-10`}>
            hire talent with the exact <br /> skills you need.
          </p>
        </div>
        <div className="flex-1 w-full sm:w-auto flex flex-col scroll-container">
          <img
            src={recruiters_mu_header}
            alt="mu_iphone"
            className="sm:w-[500px] w-[250px] self-center content-container image-container"
          />
        </div>
      </div>
      ...
      >
        <h1 className={`${styles.heading2} text-center`}>
          recruit with learnmutiny
        </h1>
        <p className={`${styles.paragraph} mt-10 text-center`}>
          hire talent with the exact skills you need.
        </p>
        <img
          src={recruiters_mu_header}
          alt="mu_iphone"
      ...
      >
        ...
        >
          <p
            className={`${styles.paragraph} font-extrabold mt-5 text-right self-center`}
          >
            gain enhanced insights <br /> on the exact skills and <br />{" "}
            qualifications of <br /> job applicants.
          </p>
        </div>
        ...
        <div className="sm:hidden flex">
          ...
          >
            gain enhanced insights on the exact skills and qualifications of job
            applicants.
          </p>
        </div>
      ...
      >
        <div
          className={`flex-1 w-full sm:w-auto flex flex-col ${styles.flexStart} justify-between`}
        >
          <p className={`${styles.paragraph} mt-10 mb-20 ml-6`}>
            filter applicants by job <br /> and sort them by score.
          </p>
      ...
      <div
        className={`sm:hidden w-full ${styles.flexCenter} ${styles.boxWidth} flex flex-col`}
      >
        <div
          className={`flex-1 w-full sm:w-auto flex flex-col ${styles.flexStart} justify-between`}
        >
          <p className={`${styles.paragraph} mt-10 mb-20 ml-6 text-center`}>
            filter applicants by job and sort them <br /> by score
          </p>
          <img src={filter_student} alt="mu_iphone" className="w-[600px]" />
        </div>
