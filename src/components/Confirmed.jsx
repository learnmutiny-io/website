    ...
    >
      ...
      >
        <div className="flex-1 self-end">
          ...
          <p
            className={`${styles.paragraph} sm:hidden flex font-extrabold mt-10 text-center`}
          >
          ...
          <div className=" flex flex-col bg-dimPrimary rounded-[35px]  w-full">
            {emailExists ? (
              ...
              <>
                ...
                <p className={`${styles.paragraph} mt-0 px-10`}>
                  be sure to check your email.
                </p>
              </>
            )}
