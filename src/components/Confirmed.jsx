...
const Confirmed = () => {
  ...
  return (
    <div
      className={`w-full flex-row ${styles.paddingX} h-screen pt-[180px]  sm:mb-0 mb-[80px]`}
    >
      <div
      ...
      >
        ...
        <div className="max-w-full h-auto flex-1 mt-10 sm:mt-0">
          <div className=" flex flex-col bg-dimPrimary rounded-[20px] w-full">
            {emailExists ? (
              <>
                <p className={`${styles.paragraph3} font-extrabold px-8 mt-8`}>
                  seems like you are already signed up for the beta.
                </p>
                <p className={`${styles.paragraph2} font-extrabold mt-0 px-8`}>
